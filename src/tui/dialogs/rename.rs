...
use crate::tui::components::{
   render_text_field, render_text_field_with_ghost, GroupGhostCompletion, ListPicker, ListPickerResult,
};
...
mod tests {
   ...
   #[test]
   fn test_esc_cancels() {
      let mut dialog = RenameDialog::new("Test", "group", "default", default_profiles(), Vec::new());
   ...
   fn test_enter_with_title_only_submits() {
      let mut dialog = RenameDialog::new("Old Title", "group", "default", default_profiles(), Vec::new());
   ...
   fn test_enter_with_group_only_submits() {
      let mut dialog = RenameDialog::new("Title", "old-group", "default", default_profiles(), Vec::new());
   ...
   fn test_enter_with_both_fields_submits() {
      let mut dialog = RenameDialog::new("Old Title", "old-group", "default", default_profiles(), Vec::new());
      // Type title
   ...
   fn test_clearing_group_removes_from_group() {
      let mut dialog = RenameDialog::new("Title", "some-group", "default", default_profiles(), Vec::new());
      // Switch to group field and clear it
      dialog.handle_key(key(KeyCode::Tab));
   ...
   fn test_char_input_ignored_on_profile_field() {
      let mut dialog = RenameDialog::new("Test", "group", "default", multi_profiles(), Vec::new());
   ...
   fn test_current_values_preserved() {
      let mut dialog = RenameDialog::new("Original", "original-group", "default", default_profiles(), Vec::new());
      dialog.handle_key(key(KeyCode::Char('N')));
      dialog.handle_key(key(KeyCode::Char('e')));
      dialog.handle_key(key(KeyCode::Char('w')));
   ...
   fn test_full_workflow_type_both_and_submit() {
      let mut dialog = RenameDialog::new("Old Name", "old/group", "default", default_profiles(), Vec::new());
   ...
   fn test_full_workflow_type_and_cancel() {
      let mut dialog = RenameDialog::new("Old Name", "group", "default", default_profiles(), Vec::new());
   ...
   fn test_submit_with_all_changes() {
      let mut dialog = RenameDialog::new("Old Title", "old-group", "default", multi_profiles(), Vec::new());
   ...
   fn sample_groups() -> Vec<String> {
      vec!["work".to_string(), "work/frontend".to_string(), "personal".to_string()]
   }

   #[test]
   fn test_ctrl_p_opens_group_picker_on_group_field() {
      let mut dialog = RenameDialog::new("Test", "group", "default", default_profiles(), sample_groups());
      // Focus group field
      dialog.handle_key(key(KeyCode::Tab));
      assert_eq!(dialog.focused_field, 1);
   ...
   fn test_group_picker_select_sets_group_field() {
      let mut dialog = RenameDialog::new("Test", "old-group", "default", default_profiles(), sample_groups());
      dialog.handle_key(key(KeyCode::Tab)); // Focus group field
   ...
   fn test_group_ghost_appears_on_typing() {
      let mut dialog = RenameDialog::new("Test", "", "default", default_profiles(), sample_groups());
      dialog.handle_key(key(KeyCode::Tab)); // Focus group field
