...
use crate::session::{
   validate_check_interval, Config, ContainerRuntimeName, DefaultTerminalMode, ProfileConfig, TmuxMouseMode,
   TmuxStatusBarMode,
};
...
fn value_display_string(value: &FieldValue) -> String {
   match value {
      ...
      FieldValue::Select { selected, options } => options.get(*selected).cloned().unwrap_or_default(),
...
pub enum FieldValue {
   ...
   Text(String),
   Number(u64),
   Select { selected: usize, options: Vec<String> },
   List(Vec<String>),
...
fn build_theme_fields(
   ...
   let (name, has_override) = resolve_value(scope, global.theme.name.clone(), theme.and_then(|t| t.name.clone()));
   ...
   let global_selected = options.iter().position(|s| s == &global.theme.name).unwrap_or(0);
...
fn build_updates_fields(
   ...
   vec![
      ...
      SettingField {
         ...
         category: SettingsCategory::Updates,
         has_override: o2,
         inherited_display: inherited_if(o2, FieldValue::Number(global.updates.check_interval_hours)),
      },
      SettingField {
...
fn build_worktree_fields(
   ...
   let (auto_cleanup, o3) = resolve_value(scope, global.worktree.auto_cleanup, wt.and_then(|w| w.auto_cleanup));
   ...
   vec![
      SettingField {
         ...
         has_override: o1,
         inherited_display: inherited_if(o1, FieldValue::Text(global.worktree.path_template.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Worktree,
         has_override: o2,
         inherited_display: inherited_if(o2, FieldValue::Text(global.worktree.bare_repo_path_template.clone())),
      },
      SettingField {
      ...
      SettingField {
         ...
         category: SettingsCategory::Worktree,
         has_override: o4,
         inherited_display: inherited_if(o4, FieldValue::Bool(global.worktree.delete_branch_on_cleanup)),
      },
   ]
}
...
fn build_sandbox_fields(
   ...
   let (auto_cleanup, o5) = resolve_value(scope, global.sandbox.auto_cleanup, sb.and_then(|s| s.auto_cleanup));
   ...
   let (mount_ssh, o8) = resolve_value(scope, global.sandbox.mount_ssh, sb.and_then(|s| s.mount_ssh));
   ...
   vec![
      SettingField {
         ...
         has_override: o1,
         inherited_display: inherited_if(o1, FieldValue::Bool(global.sandbox.enabled_by_default)),
      },
      SettingField {
         ...
         category: SettingsCategory::Sandbox,
         has_override: o3,
         inherited_display: inherited_if(o3, FieldValue::Text(global.sandbox.default_image.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Sandbox,
         has_override: o4,
         inherited_display: inherited_if(o4, FieldValue::List(global.sandbox.environment.clone())),
      },
      SettingField {
      ...
      SettingField {
         ...
         category: SettingsCategory::Sandbox,
         has_override: o_cpu,
         inherited_display: inherited_if(o_cpu, FieldValue::OptionalText(global.sandbox.cpu_limit.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Sandbox,
         has_override: o_mem,
         inherited_display: inherited_if(o_mem, FieldValue::OptionalText(global.sandbox.memory_limit.clone())),
      },
      SettingField {
      ...
      SettingField {
         ...
         category: SettingsCategory::Sandbox,
         has_override: o_ev,
         inherited_display: inherited_if(o_ev, FieldValue::List(global.sandbox.extra_volumes.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Sandbox,
         has_override: o_pm,
         inherited_display: inherited_if(o_pm, FieldValue::List(global.sandbox.port_mappings.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Sandbox,
         has_override: o7,
         inherited_display: inherited_if(o7, FieldValue::List(global.sandbox.volume_ignores.clone())),
      },
      SettingField {
      ...
      SettingField {
         ...
         description:
            "Custom instruction text appended to the agent's system prompt in sandboxed sessions (Claude, Codex only)",
...
fn build_tmux_fields(
   ...
   let (status_bar, status_bar_override) =
      resolve_value(scope, global.tmux.status_bar, tmux.and_then(|t| t.status_bar));

   let (mouse, mouse_override) = resolve_value(scope, global.tmux.mouse, tmux.and_then(|t| t.mouse));
...
fn build_session_fields(
   ...
   let extra_args_list: Vec<String> = {
      let mut items: Vec<_> = extra_args_map.iter().map(|(k, v)| format!("{}={}", k, v)).collect();
      items.sort();
      items
   };
   ...
   let cmd_override_list: Vec<String> = {
      let mut items: Vec<_> = cmd_override_map.iter().map(|(k, v)| format!("{}={}", k, v)).collect();
      items.sort();
      items
   };

   let global_tool_selected = crate::agents::settings_index_from_name(global.session.default_tool.as_deref());
   ...
   vec![
      ...
      SettingField {
         ...
         inherited_display: inherited_if(yolo_override, FieldValue::Bool(global.session.yolo_mode_default)),
      },
      SettingField {
         ...
         inherited_display: inherited_if(extra_args_override, FieldValue::List(global_extra_args_list)),
      },
      SettingField {
         ...
         inherited_display: inherited_if(cmd_override_override, FieldValue::List(global_cmd_override_list)),
      },
   ]
}
...
fn build_sound_fields(
   ...
   let (mode, o2) = resolve_value(scope, global.sound.mode.clone(), snd.and_then(|s| s.mode.clone()));
   ...
   vec![
      ...
      SettingField {
         ...
         category: SettingsCategory::Sound,
         has_override: o3,
         inherited_display: inherited_if(o3, FieldValue::OptionalText(global.sound.on_start.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Sound,
         has_override: o4,
         inherited_display: inherited_if(o4, FieldValue::OptionalText(global.sound.on_running.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Sound,
         has_override: o5,
         inherited_display: inherited_if(o5, FieldValue::OptionalText(global.sound.on_waiting.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Sound,
         has_override: o6,
         inherited_display: inherited_if(o6, FieldValue::OptionalText(global.sound.on_idle.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Sound,
         has_override: o7,
         inherited_display: inherited_if(o7, FieldValue::OptionalText(global.sound.on_error.clone())),
      },
   ]
}
...
fn build_hooks_fields(
   ...
   vec![
      SettingField {
         ...
         has_override: o1,
         inherited_display: inherited_if(o1, FieldValue::List(global.hooks.on_create.clone())),
      },
      SettingField {
         ...
         category: SettingsCategory::Hooks,
         has_override: o2,
         inherited_display: inherited_if(o2, FieldValue::List(global.hooks.on_launch.clone())),
      },
   ]
}
...
pub fn apply_field_to_config(
   ...
   match scope {
      ...
      SettingsScope::Profile | SettingsScope::Repo => apply_field_to_profile(field, global, profile),
   }
}

fn apply_field_to_global(
   field: &SettingField,
   config: &mut Config,
) {
   match (&field.key, &field.value) {
      ...
      (FieldKey::CheckIntervalHours, FieldValue::Number(v)) => config.updates.check_interval_hours = *v,
      ...
      (FieldKey::BareRepoPathTemplate, FieldValue::Text(v)) => config.worktree.bare_repo_path_template = v.clone(),
      (FieldKey::WorktreeAutoCleanup, FieldValue::Bool(v)) => config.worktree.auto_cleanup = *v,
      (FieldKey::DeleteBranchOnCleanup, FieldValue::Bool(v)) => config.worktree.delete_branch_on_cleanup = *v,
      // Sandbox
      (FieldKey::SandboxEnabledByDefault, FieldValue::Bool(v)) => config.sandbox.enabled_by_default = *v,
      ...
      (FieldKey::DefaultTool, FieldValue::Select { selected, .. }) => {
         config.session.default_tool = crate::agents::name_from_settings_index(*selected).map(|s| s.to_string());
      },
...
fn apply_field_to_profile(
   ...
   match (&field.key, &field.value) {
      ...
      (FieldKey::ThemeName, FieldValue::Select { selected, options }) => {
         ...
         let t = config.theme.get_or_insert_with(ThemeConfigOverride::default);
         t.name = Some(name);
      },
      // Updates
      ...
      (FieldKey::CheckIntervalHours, FieldValue::Number(v)) => {
         set_profile_override(*v, &mut config.updates, |s, val| s.check_interval_hours = val);
      },
      ...
      (FieldKey::PathTemplate, FieldValue::Text(v)) => {
         set_profile_override(v.clone(), &mut config.worktree, |s, val| s.path_template = val);
      },
      ...
      (FieldKey::DeleteBranchOnCleanup, FieldValue::Bool(v)) => {
         set_profile_override(*v, &mut config.worktree, |s, val| s.delete_branch_on_cleanup = val);
      },
      // Sandbox
      ...
      (FieldKey::DefaultImage, FieldValue::Text(v)) => {
         set_profile_override(v.clone(), &mut config.sandbox, |s, val| s.default_image = val);
      },
      ...
      (FieldKey::ExtraVolumes, FieldValue::List(v)) => {
         set_profile_override(v.clone(), &mut config.sandbox, |s, val| s.extra_volumes = val);
      },
      (FieldKey::PortMappings, FieldValue::List(v)) => {
         set_profile_override(v.clone(), &mut config.sandbox, |s, val| s.port_mappings = val);
      },
      (FieldKey::VolumeIgnores, FieldValue::List(v)) => {
         set_profile_override(v.clone(), &mut config.sandbox, |s, val| s.volume_ignores = val);
      },
      ...
      (FieldKey::CpuLimit, FieldValue::OptionalText(v)) => {
         ...
         let s = config.sandbox.get_or_insert_with(SandboxConfigOverride::default);
         s.cpu_limit = v.clone();
      },
      (FieldKey::MemoryLimit, FieldValue::OptionalText(v)) => {
         use crate::session::SandboxConfigOverride;
      ...
      (FieldKey::DefaultTerminalMode, FieldValue::Select { selected, .. }) => {
         ...
         set_profile_override(mode, &mut config.sandbox, |s, val| s.default_terminal_mode = val);
      },
      (FieldKey::ContainerRuntime, FieldValue::Select { selected, .. }) => {
         ...
         set_profile_override(runtime, &mut config.sandbox, |s, val| s.container_runtime = val);
      },
      // Tmux
      (FieldKey::StatusBar, FieldValue::Select { selected, .. }) => {
         let mode = match selected {
      ...
      (FieldKey::DefaultTool, FieldValue::Select { selected, .. }) => {
         ...
         let session = config.session.get_or_insert_with(SessionConfigOverride::default);
      ...
      (FieldKey::AgentExtraArgs, FieldValue::List(v)) => {
         ...
         use crate::session::SessionConfigOverride;
         let s = config.session.get_or_insert_with(SessionConfigOverride::default);
...
mod tests {
   ...
   fn test_profile_field_has_no_override_after_global_change() {
      ...
      let fields = build_fields_for_category(SettingsCategory::Updates, SettingsScope::Profile, &global, &profile);

      let check_enabled_field = fields.iter().find(|f| f.key == FieldKey::CheckEnabled).unwrap();
      assert!(
   ...
   fn test_default_tool_options_include_all_registered_agents() {
      ...
      let fields = build_fields_for_category(SettingsCategory::Session, SettingsScope::Global, &global, &profile);
   ...
   fn test_profile_override_preserved_when_matching_global() {
      ...
      let fields = build_fields_for_category(SettingsCategory::Updates, SettingsScope::Profile, &global, &profile);
      let field = fields.iter().find(|f| f.key == FieldKey::CheckEnabled).unwrap();
      ...
      assert!(
         profile.updates.as_ref().and_then(|u| u.check_enabled).is_some(),
