...
const GITHUB_SOUNDS_BASE_URL: &str = "https://raw.githubusercontent.com/njbrake/agent-of-empires/main/bundled_sounds";
...
pub fn validate_sound_exists(filename: &str) -> Result<(), String> {
   ...
   if available.is_empty() {
      return Err("No sounds installed. Run 'aoe sounds install' or add your own .wav/.ogg files.".to_string());
   }
...
pub fn apply_sound_overrides(
   target: &mut SoundConfig,
   source: &SoundConfigOverride,
) {
